...
public class User {
    String username;
    List<PlaylistInterface> playlists;
    ...
    public PlaylistInterface createPlaylist(String name, String type) {
    ...
    public void deletePlaylist(PlaylistInterface playlist) {
    ...
    public void addSongToPlaylist(PlaylistInterface playlist, Song song) {
    ...
    public void removeSongFromPlaylist(PlaylistInterface playlist, Song song) {
        if (playlists.contains(playlist)) {
    ...
    public List<PlaylistInterface> getPlaylists() {
        return playlists;
    }
